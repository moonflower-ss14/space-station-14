...
namespace Content.Shared.Preferences
{
    ...
    public sealed partial class HumanoidCharacterProfile : ICharacterProfile
    {
        ...
        /// </summary>
        [DataField]
        // private Dictionary<ProtoId<JobPrototype>, JobPriority> _jobPreferences = new()
        // {
        //     {
       ...
       // Starlight
        ...
        public HumanoidCharacterProfile(
            ...
            HashSet<ProtoId<JobPrototype>> jobPreferences, // Starlight Lobby
            ...
            Dictionary<string, FixedPoint2> cdAllergies) // CD Allergies)
        {
            ...
            _jobPreferences = jobPreferences; // Starlight lobby
        ...
        public override int GetHashCode()
        {
            ...
            hashCode.Add(_jobPreferences); // Starlight
