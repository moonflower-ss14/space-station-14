/// Initially based on Starlight code
/// See their repo Content.Shared/_Moonflower/Language.ObfuscationMethods.cs

using System.Text;
using Content.Shared._Moonflower.Language.Systems;

namespace Content.Shared._Moonflower.Language;
