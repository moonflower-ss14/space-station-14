...
//        _chime.TryGetSenderHeadsetChime(messageSource, out var chime);
        ...
        var chat = new ChatMessage(ChatChannel.Radio, message, wrappedMessage, NetEntity.Invalid, null); // Starlight
        ...
        var ev = new RadioReceiveEvent(message, messageSource, channel, chat, notUdsMsg, language, radioSource, []);
        // Starlight - End
        ...
        _replay.RecordServerMessage(chat); // Starlight-edit: Languages
